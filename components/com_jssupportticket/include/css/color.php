...
defined('_JEXEC') or die('Restricted access');
    ...
    $color10 = "";
      $style = "
            div.js_effect_preview div#js-tk-heading {background: $color1;}
            a.js-tkt-det-copy-id {color: $color1 !important;}
            div.js-form-value div.field-calendar div.input-append button{background: $color7!important;border-color: $color1 !important;color: $color1 !important;}
            ...
            div.js-combine-search-wrapper div.js-combine-search-form-wrp form.js-tk-combinesearch span.js-filter-button-wrp button.js-ticket-search-btn:hover {border-color: $color2;}
            ...
            div.js-combine-search-wrapper div.js-combine-search-form-wrp form.js-tk-combinesearch span.js-filter-button-wrp button.js-ticket-reset-btn:hover {border-color: $color1;}
            div#js-tk-wrapper span.js-tk-value.subject .js-ticket-title-anchor {color: $color1;}
            div#js-tk-wrapper span.js-tk-value .js-ticket-title-anchor:hover {color: $color2 !important;}
            div.js-ticket-signature-radio-box-wrp {border: 1px solid $color5;float: left;width: 100%;background-color: $color7;}
            div.field-calendar div.input-group-append button.btn-outline-secondary {background-color: $color7 !important;border-color: $color1 !important;color: $color1 !important;}
            div.field-calendar div.input-group-append button.btn-outline-secondary:hover{background-color: $color7 !important;border-color: $color2 !important;color: $color2 !important;}
            div#js-tk-wrapper {border: 1px solid$color5;box-shadow: 0 8px 6px -6px #dedddd;}
            div#js-tk-wrapper:hover {border: 1px solid $color1 ;box-shadow: 0 4px 4px 0px rgba(162, 162, 162, 0.71);}
            span.js-tk-title {color: $color2 ;}
            span.js-tk-value {color: $color4;}
            span.js-ticket-status {background-color: $color7;border: 1px solid $color5; }
            div.js-combine-search-wrapper div.js-combine-search-form-wrp form.js-tk-combinesearch div.js-filter-field-wrp select#filter_department {color: $color4;background-color: $color7 ;border:1px solid $color5;}
            div.js-combine-search-wrapper div.js-combine-search-form-wrp form.js-tk-combinesearch div.js-filter-field-wrp select#filter_priority   {color: $color4;background-color: $color7 ;border:1px solid $color5;}
            div.js-combine-search-wrapper div.js-combine-search-form-wrp form.js-tk-combinesearch div.js-filter-field-wrp select#filter_staffmember {color: $color4;background-color: $color7 ;border:1px solid $color5;}
            div.js-combine-search-wrapper div.js-combine-search-form-wrp form.js-tk-combinesearch div.js-filter-field-wrp select {color: $color4;}
            div.js-combine-search-wrapper div.js-combine-search-form-wrp form.js-tk-combinesearch div.js-filter-field-wrp select#filter_assignedtome {color: $color4;background-color: $color7 ;border:1px solid $color5;}
            div.js-combine-search-wrapper div.js-combine-search-form-wrp form.js-tk-combinesearch div.js-filter-wrapper {background: $color3;}
            div.js-combine-search-wrapper div.js-combine-search-form-wrp form.js-tk-combinesearch div.js-filter-field-wrp input {border: 1px solid $color5;}
            ...
            div.js-ticket-search-wrp div.js-ticket-form-wrp form.js-tk-combinesearch div.js-filter-field-wrp select#filter_department {background-color: $color7 !important;border: 1px solid$color5;color: $color4;}
            ...
            div#userpopupforchangepriority div.js-ticket-priorty-fields-wrp div.js-ticket-select-priorty select#priorityid{background-color: $color3 !important;}
            span#js-attachment-add {background-color: $color1;color: $color7;border: 1px solid $color5;}
            .table th {border: 1px solid $color5;}
            .table td {border: 1px solid $color5;}
            div.private-crendentials-add-new-popup input.js-ticket-priorty-cancel {background-color: #48484a;color: $color7;border: 1px solid transparent;}
            div.js-ticket-edit-field-wrp textarea#additional_information {width: 100%;border-radius: 0px;background-color: $color3;}
            div.private-crendentials-form-popup div.js-ticket-edit-form-wrp div.js-ticket-priorty-btn-wrp{border-top: 2px solid $color2;}
            div.js-ticket-crendential-detail-wrp{float: left;width: 100%;border:1px solid $color5;padding: 10px;color: $color4;}
            div.js-ticket-crendential-detail-wrp div.js-ticket-crendential-detail-head {color: $color2;}
            div.js-ticket-crendential-detail-wrp div.js-ticket-crendential-detail-footer input.js-ticket-priorty-save{background-color: $color1;color: $color7;border: 1px solid transparent;}
            div.js-ticket-crendential-detail-wrp div.js-ticket-crendential-detail-footer input.js-ticket-priorty-cancel{background-color: #48484a;color: $color7;border: 1px solid transparent;}
