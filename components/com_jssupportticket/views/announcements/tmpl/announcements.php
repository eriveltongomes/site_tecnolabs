...
$jsession = JSession::getFormToken();
?>
...
if($this->config['offline'] != '1'){
    ...
    $document->addStyleSheet(JURI::root().'components/com_jssupportticket/include/css/inc.css/announcement-announcements.css', 'text/css');
                    ...
                    <div class="js-ticket-announcement-wrapper">
                        <div class="js-ticket-top-search-wrp">
                            <div class="js-ticket-search-fields-wrp">
                                <form class="js-filter-form" action="<?php echo JRoute::_('index.php?option=com_jssupportticket&c=announcements&layout=announcements'); ?>" method="post" name="adminForm" id="adminForm">
                                    ...
                                    <div class="js-ticket-search-form-btn-wrp">
                                        ...
                                        <button class="js-reset-button" onclick="/*this.form.getElementById('filter_type').value = '';*/document.getElementById('filter_title').value = '';document.getElementById('filter_categoryid').value = '';this.form.submit();"><?php echo JText::_('Reset'); ?></button>
                                    </div>
                        ...
                        <?php if ((!empty($this->announcements)) && is_array($this->announcements)) {  ?>
                            ...
                            <div class="js-ticket-search-heading-wrp">
                                ...
                                <div class="js-ticket-heading-right">
                                    <?php $link = 'index.php?option='.$this->option .'&c=announcements&layout=formannouncement&Itemid='.$this->Itemid; ?>
                                    <a class="js-ticket-add-download-btn" href="<?php echo $link; ?>"><span class="js-ticket-add-img-wrp"><img src="components/com_jssupportticket/include/images/add.png" alt="Add-image"></span><?php echo JText::_('Add Announcement') ?></a> 
                                </div>
                            </div>
                                <div class="js-ticket-table-wrp js-col-md-12">
                                    ...
                                    <div class="js-ticket-table-body">
                                        <?php foreach ($this->announcements AS $row) { ?>
                                            ...
                                            <div class="js-ticket-data-row" id="tk-row-<?php echo $row->id; ?>">
                                                <div id="js-suredelete"><img id="warning-icon" src="components/com_jssupportticket/include/images/warning_icon.png" />
                                                    ...
                                                    <a class="js-tk-suredelete-btn" onclick="yesdeletethisrecord('<?php echo $row->id; ?>','announcements','removeannouncement','<?php echo $jsession; ?>');">
                                                ...
                                                <div class="js-ticket-table-body-col js-col-md-4 js-col-xs-4  js-ticket-first-child">
                                                    <span class="js-ticket-display-block"><?php echo JText::_('Title:'); ?></span>
                                                    <span class="js-ticket-title"><a class="js-ticket-title-anchor" href="<?php echo $link; ?>"><?php echo $row->title; ?></a></span>
                                                </div>
                                                ...
                                                <div class="js-ticket-table-body-col js-col-md-2 js-col-xs-2">
                                                    ...
                                                    <?php $link = 'index.php?option=' . $this->option . '&c=announcements&layout=formannouncement&id=' . $row->id . '&Itemid=' . $this->Itemid; ?>
                                ...
                                <form action="<?php echo JRoute::_('index.php?option=com_jssupportticket&c=announcements&layout=announcements&Itemid=' . $this->Itemid); ?>" method="post">
