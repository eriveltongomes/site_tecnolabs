...
if($this->config['offline'] != '1'){
    ...
    $document->addStyleSheet(JURI::root().'components/com_jssupportticket/include/css/inc.css/mail-outbox.css', 'text/css');
                    ...
                    <div class="js-ticket-mail-wrapper">
                        <div class="js-ticket-top-search-wrp">
                            <div class="js-ticket-search-fields-wrp">
                               <form class="js-filter-form" action="<?php echo JRoute::_('index.php?option=com_jssupportticket&c=mail&layout=outbox'); ?>" method="post" name="adminForm" id="adminForm">
                                    <div class="js-ticket-fields-wrp">
                                        <div class="js-ticket-form-field js-ticket-margin-bottom-select" id="search-by-title"> 
                                            ...
                                            <div class="js-ticket-form-field js-ticket-form-field-select js-ticket-margin-bottom-select">
                                        ...
                                        <div class="js-ticket-search-form-btn-wrp js-ticket-staff-search-btn-wrp js-ticket-mail-search-btn-wrp">
                                            <span id="js-filter-wrapper-toggle-btn">
                                                ...
                                                <span id="js-filter-wrapper-toggle-minus">
                                                    <a href="#" class="js-search-filter-btn show-less-btn" id="js-search-filter-toggle-btn">
                        ...
                        <div class="js-ticket-mails-btn-wrp">
                            ...
                            <div class="js-ticket-mail-btn">
                                <a class="js-add-link button active" href="index.php?option=com_jssupportticket&c=mail&layout=outbox&Itemid=<?php echo $this->Itemid; ?>">
                            ...
                            <div class="js-ticket-search-heading-wrp">
                                ...
                                <div class="js-ticket-table-wrp js-col-md-12">
                                    <div class="js-ticket-table-header">
                                        <div class="js-ticket-table-header-col  js-col-md-5 js-col-xs-5"><?php echo JText::_('Subject'); ?></div>
                                        <div class="js-ticket-table-header-col js-col-md-3 js-col-xs-3"><?php echo JText::_('To'); ?></div>
                                    ...
                                    <div class="js-ticket-table-body">
                                        <?php foreach ($this->messages AS $message) { ?>
                                                ...
                                                <?php if($message->status == 1) $icon_status = 'tick-icon.png'; else $icon_status = 'close-icon.png'; ?>
                                                <div class="js-ticket-data-row" id="tk-row-<?php echo $message->id; ?>">
                                                    ...
                                                    <div class="js-ticket-table-body-col js-ticket-first-child js-col-md-5 js-col-xs-5">
                                                        <span class="js-ticket-display-block"><?php echo JText::_('Subject:'); ?></span>
                                                        <span class="js-ticket-title"><a class="js-ticket-title-anchor"  href="<?php echo $link; ?>"><?php echo $message->subject; ?></a></span>
                                                    </div>
                                                    <div class="js-ticket-table-body-col js-col-md-3 js-col-xs-3">
                                                        <span class="js-ticket-display-block"><?php echo JText::_('To:'); ?></span>
