...
class plgContentjssupportticketlatestknowledgebase extends JPlugin {
    ...
    protected function _load($position, $style = -2) {
        ...
        $content = JSSupportTicketModel::getJSModelForMP('moduleplugin')->getContentForMP($title,$showtitle,$titlebackgroundcolor,$titlecolor,1,$viewall,$maxrecord,$recordperrow,$textoverflow,$itemid,'knowledgebase',null);
        return $content;
    }
