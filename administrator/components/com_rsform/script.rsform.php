...
.red {
	...
	<div class="rsform-column-10">
		...
		<?php } ?>
		<h2>Changelog v3.1.11</h2>
		<ul class="version-history">
			<li><span class="version-new">New</span> {fileupload:count} placeholder that returns the number of uploaded files.</li>
            <li><span class="version-fixed">Fix</span> In some installations the 'Name' and 'Default Value' of a 'Hidden Field' were showing in reverse order.</li>
            <li><span class="version-fixed">Fix</span> Restoring form backups was not working on some servers.</li>
            <li><span class="version-fixed">Fix</span> Uploading a file through the 'Select File From Server' window would show an error on Joomla! 4.</li>
		</ul>
