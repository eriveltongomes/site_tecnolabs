...
class com_rsseoInstallerScript 
{
	...
	public function postflight($type, $parent) {
		...
		if ($type == 'update') {
			...
			if (!$registry->exists('sitemapwebsite')) $registry->set('sitemapwebsite', JUri::root());
			...
			if (file_exists(JPATH_SITE.'/sitemap.xml')) {
				if ($contents = file_get_contents(JPATH_SITE.'/sitemap.xml', false, null, 0, 200)) {
					if (strpos($contents, 'components/com_rsseo/sitemap.xsl') === FALSE) {
						...
						$sitemap = str_replace("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n", "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n".'<?xml-stylesheet type="text/xsl" href="'.JUri::root().'components/com_rsseo/sitemap.xsl"?>'."\n", $sitemap);
...
<div id="installer-right">
	<h2>Changelog v1.21.19</h2>
	<ul class="version-history">
		<li><span class="version-fixed">Add</span> The crawler was not working for some Joomla! installations.</li>
	</ul>
