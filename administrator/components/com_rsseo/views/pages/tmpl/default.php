...
<form action="<?php echo JURI::getInstance(); ?>" method="post" name="adminForm" id="adminForm">
	...
	<?php $footer = '<a href="javascript:void(0)" onclick="Joomla.submitbutton(\'pages.batch\');" class="btn btn-primary">'.JText::_('COM_RSSEO_APPLY').'</a><a href="javascript:void(0)" data-bs-dismiss="modal" data-dismiss="modal" class="btn">'.JText::_('COM_RSSEO_GLOBAL_CLOSE').'</a>'; ?>
