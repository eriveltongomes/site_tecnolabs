		...
		<fieldset class="options-form">
			...
			<div class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<button id="sitemapbtn" class="btn btn-primary button" type="button" onclick="RSSeo.createSitemap(1, <?php echo (int) rsseoHelper::getConfig('enable_sitemap_cron'); ?>);" <?php echo $disabled; ?>><?php echo JText::_('COM_RSSEO_GENERATE_SITEMAP'); ?></button>
					</div>
				</div>
			</div>
		...
		<fieldset class="options-form">
			...
			<div class="<?php echo RSSeoAdapterGrid::row(); ?>">
				<div class="<?php echo RSSeoAdapterGrid::column(6); ?>">
					...
					<joomla-field-fancy-select class="menus_fancy" placeholder="<?php echo JText::_('JGLOBAL_TYPE_OR_SELECT_SOME_OPTIONS'); ?>">
				...
				<div class="<?php echo RSSeoAdapterGrid::column(6); ?>">
					<label for="assetgroups_1" class="rsnofloat"><?php echo JText::_('COM_RSSEO_SITEMAP_HTML_EXCLUDE_MENU_ITEMS'); ?></label> <br>
					<?php $excludeSelected = unserialize(base64_decode(rsseoHelper::getConfig('sitemap_excludes'))); ?>
					<joomla-field-fancy-select class="exclude_fancy" placeholder="<?php echo JText::_('JGLOBAL_TYPE_OR_SELECT_SOME_OPTIONS'); ?>">
			...
			<div class="<?php echo RSSeoAdapterGrid::row(); ?>" style="margin-top: 1rem;">
				<div class="control-group">
					<div class="controls">
						<button class="btn btn-primary" type="button" onclick="Joomla.submitbutton('sitemap.html');"><?php echo JText::_('COM_RSSEO_GENERATE_SITEMAP'); ?></button>
					</div>
				</div>
			</div>
		</fieldset>
