	...
	<div class="grid-x grid-margin-x margin-y">
        ...
        if (acym_level(ACYM_ESSENTIAL)) {
            ...
            if ($expirationDate > time()) {
				...
				<div class="cell medium-3 automatic_only automatic_manual"><?php echo acym_translation('ACYM_IMPORTANT_INFORMATION'); ?></div>
				<div class="cell medium-9 automatic_only automatic_manual"><?php echo acym_translationSprintf('ACYM_CRON_WHITELIST', ACYM_YOURCRONTASK_IP); ?></div>
                <?php
            }
        }
        ?>
		...
		<div id="acym__configuration__queue__advanced__content" style="display:none;">
			<div class="margin-bottom-2">
				...
				<div class="grid-x grid-margin-x margin-y">
					...
					<div class="cell large-2 medium-3"><label for="cron_sendto"><?php echo acym_translation('ACYM_REPORT_SEND_TO').acym_info('ACYM_REPORT_SEND_TO_DESC'); ?></label>
					</div>
					<div class="cell large-4 medium-9">
                        <?php
                        $emails = [];
					...
					<div class="cell large-2 medium-3"><label for="cronsavereport"><?php echo acym_translation('ACYM_REPORT_SAVE').acym_info('ACYM_REPORT_SAVE_DESC'); ?></label>
					</div>
					<div class="cell large-4 medium-9">
                        <?php
                        $cronsave = [];
					...
					<div class="cell large-2 medium-3"><label for="cron_savepath"><?php echo acym_translation('ACYM_REPORT_SAVE_TO').acym_info(
                                    'ACYM_REPORT_SAVE_TO_DESC'
                                ); ?></label></div>
					<div class="cell large-4 medium-9">
