            ...
            if (!(empty($this->priority)) && is_array($this->priority)) {  ?>
                    <table id="js-table" class="js-ticket-box-shadow">
                        ...
                        <tr>
                            ...
                            <th class="center"><?php echo JText::_("Overdue").' '.JText::_("type"); ?></th>
                            <th class="center"><?php echo JText::_("Overdue interval in"); ?><br><?php echo JText::_("Days/Hours"); ?></th>
                        ...
                        <tbody>
                            ...
                            foreach ($this->priority AS $row) {
                                ...
                                <tr>
                                    ...
                                    <td class="center"><?php if($row->overduetypeid == 1) echo JText::_("Days"); elseif($row->overduetypeid == 2) echo JText::_("Hours"); ?></td>
                                    <td class="center"><?php echo JText::_($row->overdueinterval); ?></td>
