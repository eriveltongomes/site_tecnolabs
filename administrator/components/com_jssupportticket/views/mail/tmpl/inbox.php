...
<div id="js-tk-admin-wrapper">
    ...
    <div id="js-tk-cparea">
        ...
        <div id="js-tk-heading">
            <h1 class="jsstadmin-head-text"><?php echo JText::_('inbox'); ?></h1>
        </div>
        <form class="jsstadmin-data-wrp" action="index.php" method="post" name="adminForm" id="adminForm">
            <div id="js-tk-filter">
                ...
                <div class="tk-search-value"><?php echo JHtml::_('select.genericList', $read, 'read', 'class="inputbox "' . '', 'value', 'text', $this->lists['read']); ?></div>
                ...
                <div class="tk-search-button">
                    ...
                    <button class="js-form-reset" onclick="document.getElementById('read').value = ''; document.getElementById('filter_subject').value = ''; document.getElementById('startdate').value = ''; document.getElementById('enddate').value = ''; document.getElementById('filter_type').value = ''; this.form.submit();"><?php echo JText::_('Reset'); ?></button>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            foreach ($this->messages AS $message) {
                                ...
                                <tr>
                                    ...
                                    <td><?php if ($message->isread == 2) echo '<b>'; ?><a  href="<?php echo $link; ?>"> <?php if ($message->count != 0) echo $message->subject . ' ' . JText::_('Re'); else echo $message->subject; ?></a><?php if ($message->isread == 2) echo '</b>'; ?></td>
