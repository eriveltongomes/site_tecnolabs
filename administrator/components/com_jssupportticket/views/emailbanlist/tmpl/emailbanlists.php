...
<div id="js-tk-admin-wrapper">
    ...
    <div id="js-tk-cparea">
            ...
            <div id="jsstadmin-wrapper-top-left">
                <div id="jsstadmin-breadcrunbs">
                    <ul>
                        ...
                        <li><?php echo JText::_('Ban Emails'); ?></li>
                    </ul>
                </div>
            </div>
        ...
        <div id="js-tk-heading">
            <h1 class="jsstadmin-head-text"><?php echo JText::_('Ban Emails'); ?></h1>
            <?php $link = 'index.php?option='.$this->option.'&c=emailbanlist&task=addnewemail'; ?>
        ...
        <form class="jsstadmin-data-wrp" action="index.php" method="post" name="adminForm" id="adminForm">
            <div id="js-tk-filter">
                <div class="tk-search-value"><input type="text" name="filter_email" id="filter_email" placeholder="<?php echo JText::_('Email'); ?>" value="<?php if (isset($this->searchemail)) echo $this->searchemail; ?>" class="text_area" /></div>
                <div class="tk-search-button">
                    <button class="js-form-search" onclick="this.form.submit();"><?php echo JText::_('Search'); ?></button>
                    <button class="js-form-reset" onclick="document.getElementById('filter_email').value = ''; this.form.submit();"><?php echo JText::_('Reset'); ?></button>
                </div>
            </div>
            <?php
                    ...
                    <table id="js-table" class="js-ticket-box-shadow">
                        ...
                        <tbody>
                            ...
                            foreach ($this->emails AS $row) {
                                ...
                                $editlink = 'index.php?option=' . $this->option .'&c=emailbanlist&layout=formemailbanlist&cid[]=' . $row->id;
                                $deletelink = 'index.php?option='.$this->option.'&c=emailbanlist&task=deleteemail&cid[]='.$row->id.'&'. JSession::getFormToken() .'=1'; ?>
                                <tr>
                                    <td class="center"><?php echo $k + 1 + $this->pagination->limitstart; ?></td>
                                    <td><a href="<?php echo $editlink;?>"><?php echo $row->email; ?></a></td>
                                    <td><?php if($row->username != '') echo $row->username; else echo $row->firstname.' '.$row->lastname; ?></td>
            ...
            <input type="hidden" name="layout" value="emailbanlists"/>
