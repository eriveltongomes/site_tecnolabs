...
$link_export = 'index.php?option='.$this->option.'&c=export&task='.$t_name.'&uid='.$this->result['user_report']->id.'&date_start='.$date_start.'&date_end='.$date_end;
$dash = '-';
...
<div id="js-tk-admin-wrapper">
    ...
    <div id="js-tk-cparea">
            ...
            <div id="jsstadmin-wrapper-top-left">
                <div id="jsstadmin-breadcrunbs">
                    <ul>
                        ...
                        <li>
                            <a href="index.php?option=com_jssupportticket&c=reports&layout=userreport" title="Dashboard">
                                <?php echo JText::_('User Reports'); ?>
                            </a>
                        </li>
                        <li>
                            <?php echo JText::_('User Detail Report'); ?>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div id="js-tk-heading">
            <h1 class="jsstadmin-head-text"><?php echo JText::_('User Detail Report'); ?></h1>
            ...
            <form class="jsstadmin-data-wrp" name="jssupportticketform" id="jssupportticketform" method="post" action="index.php">
                <div id="js-tk-filter">
                    ...
                    <div class="tk-search-button">
                        ...
                        <input type="hidden" name="id" id="id" value="<?php echo $this->result['user_report']->id; ?>" />
                        <input type="hidden" name="option" id="option" value="com_jssupportticket" />
                        <input type="hidden" name="c" id="c" value="reports" />
                        <input type="hidden" name="layout" id="layout" value="userdetailreport" />
                    </div>
                </div>
            ...
            <?php 
                            ...
                            <div class="js-report-staff-cnt">
                                ...
                                <div class="js-report-staff-username">
                                    <?php
                                        ...
                                        }elseif(isset($staff->user_nicename)){
                ...
                <?php
                    if(!empty($this->result['user_tickets'])){
                        ?>
                            <div class="js-ticket-admin-cp-tickets">
                                <div class="js-ticket-admin-cp-head js-ticket-admin-hide-head">
                                    ...
                                    <div class="js-col-xs-12 js-col-md-2 js-report-detail-head"><?php echo JText::_('Time'); ?></div>
                                    <div class="js-col-xs-12 js-col-md-1 js-report-detail-head"><?php echo JText::_('Rating'); ?></div>
                                </div>
                            <?php
                            foreach($this->result['user_tickets'] AS $ticket){ 
                            ...
                            echo " : "; ?></span>
                                    ...
                                    <div class="js-col-xs-12 js-col-md-2 js-report-detail-body"><span class="js-ticket-admin-cp-showhide" ><?php echo JText::_('Created');
                                            echo " : "; ?></span> <?php echo JHtml::_('date',$ticket->created,$this->config['date_format']); ?>
                                    </div>
                                    <div class="js-col-xs-12 js-col-md-2 js-report-detail-body">
                                        <span class="js-ticket-admin-cp-showhide" >
