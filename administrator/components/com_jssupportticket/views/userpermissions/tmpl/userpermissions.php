...
<div id="js-tk-admin-wrapper">
    ...
    <div id="js-tk-cparea">
            ...
            <div id="jsstadmin-wrapper-top-left">
                <div id="jsstadmin-breadcrunbs">
                    <ul>
                        ...
                        <li><?php echo JText::_('Assign User Permissions'); ?></li>
                    </ul>
                </div>
            </div>
        ...
        <div id="js-tk-heading"><h1 class="jsstadmin-head-text"><?php echo JText::_('Assign User Permissions'); ?></h1></div>
        ...
        <form action="index.php" method="post" name="adminForm" id="adminForm">
            ...
            <div class="js-per-wrapper">
                <?php
                foreach ($this->userdepartment AS $dep) { ?>
                    <div class="js-col-md-4 js-per-datawrapper">
                    <div class="js-per-data">
                        <?php $dchecked_or_not = ""; ?>
                        <?php if (isset($dep->userdepartmentid)) {
                ...
                $pgroup = "";
                foreach ($this->userpermission AS $per) { ?>
                    <?php
                   ...
                   <div class="js-per-wrapper">
                    ...
                    <div class="js-per-data">
                        <?php $checked_or_not = ""; ?>
                        <?php if (isset($per->userpermissionid)) {
            ...
            <input type="hidden" name="c" value="userpermissions" />
            <input type="hidden" name="layout" value="userpermissions" />
