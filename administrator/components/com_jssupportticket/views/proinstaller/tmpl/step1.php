                            ...
                            <?php if ($this->result['admin_dir'] < 755 || $this->result['site_dir'] < 755 || $this->result['tmp_dir'] < 755) { ?>
                                <div class="jsst_error_messages">
                                    ...
                                    <?php if($this->result['admin_dir'] < 755){ ?>
                                          <span class="jsst_msg">"<?php echo JPATH_ROOT."/administrator/components/com_jssupportticket"; ?>"&nbsp;<?php echo JText::_('is not writeable'); ?></span>
                                    <?php } ?>
                                    <?php if($this->result['site_dir'] < 755){ ?>
                                          <span class="jsst_msg">"<?php echo JPATH_ROOT."/components/com_jssupportticket"; ?>"&nbsp;<?php echo JText::_('is not writeable'); ?></span>
                                    <?php } ?>
                                    <?php if($this->result['tmp_dir'] < 755){ ?>
                                          <span class="jsst_msg">"<?php echo JPATH_ROOT."/tmp"; ?>"&nbsp;<?php echo JText::_('is not writeable'); ?></span>
                                    <?php } ?>
                                </div>    
                            <?php } ?>
