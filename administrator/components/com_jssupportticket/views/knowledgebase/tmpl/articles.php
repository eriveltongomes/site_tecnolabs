...
<div id="js-tk-admin-wrapper">
    ...
    <div id="js-tk-cparea">
            ...
            <div id="jsstadmin-wrapper-top-left">
                <div id="jsstadmin-breadcrunbs">
                    <ul>
                        ...
                        <li><?php echo JText::_('knowledge Base'); ?></li>
                    </ul>
                </div>
            </div>
        ...
        <div id="js-tk-heading">
            <h1 class="jsstadmin-head-text"><?php echo JText::_('knowledge Base'); ?></h1>
            <?php $link = 'index.php?option='.$this->option.'&c=knowledgebase&task=editknowledgebasearticle&cid[]=""'; ?>
        ...
        <form class="jsstadmin-data-wrp" action="index.php" method="post" name="adminForm" id="adminForm">
            <div id="js-tk-filter">
                <div class="tk-search-value"><input type="text" name="filter_kb_articletitle" id="filter_kb_articletitle" placeholder="<?php echo JText::_('Title'); ?>" value="<?php if (isset($this->lists['articletitle'])) echo $this->lists['articletitle']; ?>" class="text_area"/></div>
                <div class="tk-search-value"><?php echo $this->lists['categories']; ?></div>
                ...
                <div class="tk-search-button">
                    ...
                    <button class="js-form-reset" onclick="document.getElementById('filter_kb_articletitle').value = ''; /*this.form.getElementById('filter_kb_typeid').value = '';*/ document.getElementById('filter_kb_categoryid').value = ''; this.form.submit();"><?php echo JText::_('Reset'); ?></button>
                </div>
            </div>
            <?php
            if (!(empty($this->article)) && is_array($this->article)) {  ?>
                    <table id="js-table" class="js-ticket-box-shadow">
                        ...
                        <tbody>
                            ...
                            foreach ($this->article AS $row) {
                                ...
                                $editlink = 'index.php?option='.$this->option.'&c=knowledgebase&task=editknowledgebasearticle&cid[]=' . $row->id;
                                $deletelink = 'index.php?option='.$this->option.'&c=knowledgebase&task=deleteknowledgebasearticle&cid[]='.$row->id.'&'. JSession::getFormToken() .'=1'; ?>
                                <tr>
                                    <td class="center"><?php echo $k + 1 + $this->pagination->limitstart; ?></td>
                                    <td><a href="<?php echo $editlink;?>"><?php echo $row->subject; ?></a></td>
                                    <td><?php echo JText::_($row->articlecategory); ?></td>
                                    <?php /*<td><?php if ($row->type == 0) echo JText::_('Public');elseif($row->type == 1) echo JText::_('Private'); elseif($row->type == 2)echo JText::_('Draft'); ?></td>*/ ?>
            ...
            <input type="hidden" name="layout" value="articles"/>
