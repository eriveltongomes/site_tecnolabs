...
<div id="js-tk-admin-wrapper">
    ...
    <div id="js-tk-cparea">
        ...
        <div id="js-tk-heading">
            <h1 class="jsstadmin-head-text"><?php echo JText::_('Roles'); ?></h1>
            <?php $link = 'index.php?option='.$this->option.'&c=roles&task=editrole&cid[]=""'; ?>
        ...
        <form class="jsstadmin-data-wrp" action="index.php" method="post" name="adminForm" id="adminForm">
            <div id="js-tk-filter">
                <div class="tk-search-value"><input type="text" placeholder="<?php echo JText::_('Role name'); ?>" name="filter_role" id="filter_role" value="<?php if (isset($this->searchrole)) echo $this->searchrole; ?>"/></div>
                <div class="tk-search-button">
                    <button class="js-form-search" onclick="this.form.submit();"><?php echo JText::_('Search'); ?></button>
                    <button class="js-form-reset" onclick="document.getElementById('filter_role').value = ''; this.form.submit();"><?php echo JText::_('Reset'); ?></button>
                </div>
            </div>
            <?php
            if (!(empty($this->roles)) && is_array($this->roles)) {  ?>
                    <table id="js-table" class="js-ticket-box-shadow">
                        ...
                        <tr>
                            ...
                            <th><?php echo JText::_("Role name"); ?></th>
                            <th><?php echo JText::_("Permissions"); ?></th>
                        ...
                        <tbody>
                            ...
                            foreach ($this->roles AS $row) {
                                ...
                                $editlink = 'index.php?option='.$this->option.'&c=roles&task=editrole&cid[]=' . $row->id;
                                $deletelink = 'index.php?option='.$this->option.'&c=roles&task=removerole&cid[]='.$row->id.'&'. JSession::getFormToken() .'=1'; 
                                ?>                                
                                <tr>
                                    <td class="center"><?php echo $k + 1 + $this->pagination->limitstart; ?></td>
                                    <td><a href="<?php echo $editlink;?>"><?php echo JText::_($row->name); ?></a></td>
                                    <td><a href="<?php echo $r_p_link; ?>"> <?php echo JText::_($row->name) . ' ' . JText::_('Permissions'); ?></a></td>
                                    <td class="center">
