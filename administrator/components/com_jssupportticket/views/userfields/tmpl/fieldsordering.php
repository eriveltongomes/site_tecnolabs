        ...
        <div id="js-tk-heading">
            ...
            <a class="tk-heading-addbutton" href="<?php echo $link; ?>">
                ...
                if($_SESSION['ffusr'] == 1){
                    ...
                    echo JText::_('Add').' '.JText::_('Feedback').' '.JText::_('Field');
                }
                ?>
            </a>
        </div>
            ...
            if (!(empty($this->fields)) && is_array($this->fields)) {  ?>
                    <table id="js-table" class="js-ticket-box-shadow">
                        ...
                        <tr>
                            ...
                            <th class="center"><?php echo JText::_('Visitor Published'); ?></th>
                        ...
                        foreach ($this->fields AS $row) {
                            ...
                            $valt = $row->isvisitorpublished ? JText::_('Published') : JText::_('Unpublished');
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php 
                                        if ($row->fieldtitle) {
                                            ...
                                            echo JText::_($row->userfieldtitle);
                                        }
                                ...
                                <td class="center">
                                    <?php 
                                        if ($row->cannotunpublish == 1) { ?>
                                            <img src="components/com_jssupportticket/include/images/<?php echo $vpubimg; ?>" width="16" height="16" border="0" title="<?php echo JText::_('Can Not Unpublished'); ?>" />
                                        <?php } else { ?>
                                            <?php $status_link = JFilterOutput::ampReplace('index.php?option='.$this->option.'&task=userfields.'.$vpubtask.'&cid[]='.$row->id.'&'.$token.'=1'); ?>
                                            <a href="<?php echo $status_link;?>">
