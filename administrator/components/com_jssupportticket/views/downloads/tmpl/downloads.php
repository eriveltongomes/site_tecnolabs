...
<div id="js-tk-admin-wrapper">
    ...
    <div id="js-tk-cparea">
            ...
            <div id="jsstadmin-wrapper-top-left">
                <div id="jsstadmin-breadcrunbs">
                    <ul>
                        ...
                        <li><?php echo JText::_('Downloads'); ?></li>
                    </ul>
                </div>
            </div>
        ...
        <div id="js-tk-heading">
            <h1 class="jsstadmin-head-text"><?php echo JText::_('Downloads'); ?></h1>
            <?php $link = 'index.php?option='.$this->option.'&c=downloads&task=editdownloads'; ?>
        ...
        <form action="index.php" method="post" name="adminForm" id="adminForm" class="jsstadmin-data-wrp">
            <div id="js-tk-filter">
                ...
                <div class="tk-search-button">
                    ...
                    <button class="js-form-reset" onclick="document.getElementById('filter_title').value = ''; document.getElementById('filter_categoryid').value = ''; this.form.submit();"><?php echo JText::_('Reset'); ?></button>
                </div>
            </div>
            <?php
            if (!(empty($this->downloads)) && is_array($this->downloads)) {  ?>
                    <table id="js-table" class="js-ticket-box-shadow">
                        ...
                        <tr>
                            ...
                            <th class="center"><?php echo JText::_("Attachments"); ?></th>
                        ...
                        <tbody>
                            ...
                            foreach ($this->downloads AS $row) {
                                ...
                                $editlink = 'index.php?option=' . $this->option .'&c=downloads&layout=formdownload&cid[]=' . $row->id;
                                $deletelink = 'index.php?option='.$this->option.'&c=downloads&task=deletedownloads&cid[]='.$row->id.'&'. JSession::getFormToken() .'=1'; ?>
                                <tr>
                                    <td class="center"><?php echo $k + 1 + $this->pagination->limitstart; ?></td>
                                    <td><a href="<?php echo $editlink;?>"><?php echo $row->title; ?></a></td>
                                    <td><?php echo JText::_($row->downcategory); ?></td>
                                    <td class="center"><?php echo $row->totalattachment; ?></td>
