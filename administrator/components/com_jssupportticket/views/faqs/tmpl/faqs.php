...
<div id="js-tk-admin-wrapper">
    ...
    <div id="js-tk-cparea">
        ...
        <div id="js-tk-heading">
            <h1 class="jsstadmin-head-text"><?php echo JText::_('FAQs'); ?></h1>
            <?php $link = 'index.php?option='.$this->option.'&c=faqs&task=editfaqs&cid[]=""'; ?>
        ...
        <form class="jsstadmin-data-wrp"  action="index.php" method="post" name="adminForm" id="adminForm">
            <div id="js-tk-filter">
                <div class="tk-search-value"><input type="text" name="filter_subject" id="filter_subject" placeholder="<?php echo JText::_('Title'); ?>" value="<?php if (isset($this->lists['filter_subject'])) echo $this->lists['filter_subject']; ?>" class="text_area"/></div>
                ...
                <div class="tk-search-button">
                    ...
                    <button class="js-form-reset" onclick="document.getElementById('filter_subject').value = ''; document.getElementById('filter_categoryid').value = ''; this.form.submit();"><?php echo JText::_('Reset'); ?></button>
                </div>
            </div>
            <?php
                ...
                <table id="js-table" class="js-ticket-box-shadow">
                        ...
                        <tbody>
                            ...
                            foreach ($this->faqs AS $row) {
                                ...
                                $editlink = 'index.php?option='.$this->option.'&c=faqs&task=editfaqs&cid[]='.$row->id;
                                $deletelink = 'index.php?option='.$this->option.'&c=faqs&task=deletefaq&cid[]='.$row->id.'&'. JSession::getFormToken() .'=1'; ?>
                                <tr>
                                    <td class="center"><?php echo $k + 1 + $this->pagination->limitstart; ?></td>
                                    <td><a href="<?php echo $editlink;?>"><?php echo $row->subject; ?></a></td>
                                    <td><?php echo JText::_($row->faqcategory); ?></td>
            ...
            <input type="hidden" name="layout" value="faqs"/>
