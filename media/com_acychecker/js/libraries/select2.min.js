        ...
        S2.define('select2/i18n/en', [], function () {
            ...
            return {
                ...
                errorLoading: function () {
                    return ACYC_LANGUAGES.ACYC_SELECT2_RESULTS_NOT_LOADED;
                },
                inputTooLong: function (args) {
                    var overChars = args.input.length - args.maximum;

                    var message = this.sprintf(ACYC_LANGUAGES.ACYC_SELECT2_DELETE_X_CHARACTERS, overChars);
                ...
                inputTooShort: function (args) {
                    ...
                    var message = this.sprintf(ACYC_LANGUAGES.ACYC_SELECT2_ENTER_X_CHARACTERS, remainingChars);

                    return message;
                },
                loadingMore: function () {
                    return ACYC_LANGUAGES.ACYC_SELECT2_LOADING_MORE_RESULTS;
                },
                maximumSelected: function (args) {
                    var message = this.sprintf(ACYC_LANGUAGES.ACYC_SELECT2_LIMIT_X_ITEMS, args.maximum);

                    return message;
                },
                noResults: function () {
                    return ACYC_LANGUAGES.ACYC_NO_RESULTS_FOUND;
                },
                searching: function () {
                    return ACYC_LANGUAGES.ACYC_SELECT2_SEARCHING;
                }
            };
        });
